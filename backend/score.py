...
async def create_source_knowledge_graph_url(
    ...
    try:
        ...
        if source_type == 's3 bucket' and aws_access_key_id and aws_secret_access_key:
            ...
            lst_file_name,success_count,failed_count = await asyncio.to_thread(create_source_node_graph_url_gcs,graph, model, gcs_bucket_name, gcs_bucket_folder, source_type
            )
