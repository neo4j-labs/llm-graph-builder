    ...
    def create_source_node(self, obj_source_node:sourceNode):
        try:
            ...
            self.graph.query("""MERGE(d:Document {fileName :$fn}) SET d.fileSize = $fs, d.fileType = $ft ,
                            ...
                            d.gcsBucketFolder= $gcs_bucket_folder, d.language= $language""",
                            ...
                            "gcs_bucket": obj_source_node.gcsBucket, "gcs_bucket_folder": obj_source_node.gcsBucketFolder, "language":obj_source_node.language})
        except Exception as e:
            error_message = str(e)
