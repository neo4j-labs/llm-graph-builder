...
from src.shared.common_fn import get_value_from_env_or_sm, load_embedding_model 
...
ragas_embedding_model = get_value_from_env_or_sm("RAGAS_EMBEDDING_MODEL","openai")
