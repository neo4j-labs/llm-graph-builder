...
CHAT_TOKEN_CUT_OFF = {
  ("gemini_3.1_pro_preview", "gemini_3.1_flash_preview","groq-llama3",'groq_llama3_70b','anthropic_claude_4.6_sonnet','anthropic_claude_4') : 4, 
  ("openai_gpt_5.5","diffbot","openai_gpt_5.4_mini") : 28,
     ("ollama_llama3") : 2  
}  
