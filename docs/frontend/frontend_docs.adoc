...
image::images/NoFiles.jpg[User not Connection, 600]
...
User can also use the chat only feature by navigating to the url at: [Chat-Only](https://llm-graph-builder.neo4jlabs.com/chat-only) to ask questions related to documents which have been completely processed. User is required to pass the login credentials to connect to the database.
