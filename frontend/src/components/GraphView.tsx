import { Banner, Checkbox, Dialog, LoadingSpinner } from '@neo4j-ndl/react';
...
import InteractiveNvlWrapperComponent from './InteractiveNvlWrapper';

const GraphView: React.FunctionComponent<GraphViewModalProps> = ({
    open,
    inspectedName,
    setGraphViewOpen,
    viewPoint,
                            ...
                            <>
                                <div className='flex' style={{ height: '100%' }}>
                                    <div className='bg-palette-neutral-bg-default relative' style={{ width: '100%', flex: '1' }}>
                                        <InteractiveNvlWrapperComponent 
                                            nodes={nodes}
