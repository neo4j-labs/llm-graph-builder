...
const ResultOverview: React.FunctionComponent<OverViewProps> = ({ nodes, relationships, newScheme, searchQuery, setSearchQuery, viewPoint, setNodes, setRelationships }) => {
